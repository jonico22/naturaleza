...
export default function Page() {
    ...
    <section className='text-lg max-w-screen-xl mx-auto py-10 px-10'>
        ...
        <div className=" h-auto mt-5 mb-10 px-5 py-7 ">
          <div className="text-center">
            <h2 className="relative text-2xl whitespace-nowrap font-extrabold mb-10 after:absolute after:w-1/6 after:h-1 after:left-0 after:right-0 after:-bottom-4 after:mx-auto after:bg-primaryNature after:rounded-full">Misión</h2>
            <p className=" text-[#333] leading-relaxed pt-5">Queremos ser una organización reconocida por el impacto de nuestras actuaciones en el bienestar
          y el desarrollo de la sociedad peruana, así como por nuestra integridad y profesionalidad en el modo de actuar.</p>
          </div>
        </div>
        <div className="max-w-6xl mx-auto  text-[#333] ">
          <h2 className="relative sm:text-2xl text-2xl font-extrabold text-center mb-10 after:absolute after:w-1/6 after:h-1 after:left-0 after:right-0 after:-bottom-4 after:mx-auto after:bg-primaryNature after:rounded-full">Valores</h2>
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
            ...
            <g fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="30" clip-path="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
              ...
              <p className="text-gray-500 text-sm">Consideramos el respeto como un valor imprescindible que promueve la paz y la convivencia entre las personas. Y reconocemos y defendemos la diversidad cultural y ambiental.
              </p>
            </div>
            <div className="p-4 text-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-8 mb-4 inline-block" viewBox="0 0 682.667 682.667">
              ...
              <p className="text-gray-500 text-sm">Entendemos que la responsabilidad conjunta en el desarrollo integral del ser humano es el valor esencial para el logro del bien común.</p>
            </div>
            <div className="p-4 text-center">
              ...
              <p className="text-gray-500 text-sm">Actuamos comprometidos en el cumplimiento de nuestra misión y visión y con la integridad, como principio fundamental de nuestras actuaciones.</p>
            </div>
            <div className="p-4 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Justicia Global</h3>
              <p className="text-gray-500 text-sm">Defendemos un enfoque de desarrollo basado en los Derechos Humanos y la justicia climática, orientado a su cumplimiento y a erradicar las desigualdades globales.</p>
            </div>
            <div className="p-4 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Igualdad</h3>
              <p className="text-gray-500 text-sm">Creemos que todas las personas tienen derecho a recibir un trato justo y a gozar de los mismos derechos y oportunidades.</p>
            </div>
          </div>
        </div>
    </section>
